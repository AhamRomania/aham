...
func newMessagesTableImpl(schemaName, tableName, alias string) messagesTable {
	var (
		...
		ChatColumn      = postgres.IntegerColumn("chat")
		FromColumn      = postgres.IntegerColumn("from")
		MessageColumn   = postgres.StringColumn("message")
		SeenColumn      = postgres.StringColumn("seen")
		CreatedAtColumn = postgres.TimestampColumn("created_at")
		allColumns      = postgres.ColumnList{IDColumn, ChatColumn, FromColumn, MessageColumn, SeenColumn, CreatedAtColumn}
		mutableColumns  = postgres.ColumnList{ChatColumn, FromColumn, MessageColumn, SeenColumn, CreatedAtColumn}
	)
