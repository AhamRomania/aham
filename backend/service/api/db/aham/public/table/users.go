...
func newUsersTableImpl(schemaName, tableName, alias string) usersTable {
	var (
		...
		allColumns                 = postgres.ColumnList{IDColumn, EmailColumn, PasswordColumn, GivenNameColumn, FamilyNameColumn, PhoneColumn, CityColumn, PictureColumn, SourceColumn, RoleColumn, MetaColumn, ThirdParyAccessTokenColumn, EmailActivationTokenColumn, PhoneActivationTokenColumn, CreatedAtColumn, EmailActivatedAtColumn, PhoneActivatedAtColumn}
		mutableColumns             = postgres.ColumnList{EmailColumn, PasswordColumn, GivenNameColumn, FamilyNameColumn, PhoneColumn, CityColumn, PictureColumn, SourceColumn, RoleColumn, MetaColumn, ThirdParyAccessTokenColumn, EmailActivationTokenColumn, PhoneActivationTokenColumn, CreatedAtColumn, EmailActivatedAtColumn, PhoneActivatedAtColumn}
	)
